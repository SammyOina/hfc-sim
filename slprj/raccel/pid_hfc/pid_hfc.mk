...
MODEL                   = pid_hfc
MODULES                 = rt_matrx.c rt_printf.c rt_logging_simtarget.c pid_hfc.c pid_hfc_capi.c pid_hfc_data.c pid_hfc_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT                 = pid_hfc.exe
MAKEFILE                = pid_hfc.mk
MATLAB_ROOT             = C:\Polyspace\R2021a
ALT_MATLAB_ROOT         = C:\POLYSP~1\R2021a
START_DIR               = D:\Documents\hfc
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 3
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = /LIBPATH:"C:\Polyspace\R2021a\extern\lib\win64\microsoft" libmwsl_simtarget_instrumentation.lib libmwipp.lib libut.lib libmx.lib libmex.lib libmat.lib libmwmathutil.lib libmwslsa_sim.lib libmwslexec_simbridge.lib libmwsl_fileio.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib libmwsl_services.lib libmwsdi_raccel.lib libmwi18n.lib libmwcoder_target_services.lib libmwcoder_ParamTuningTgtAppSvc.lib libfixedpoint.lib libmwslexec_simlog.lib libmwstringutil.lib
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pid_hfc_ref.rsp
COMPILER_COMMAND_FILE     = pid_hfc_comp.rsp
...
sfun_spid_contc.obj : $(MATLAB_ROOT)\toolbox\physmod\powersys\powersys\sfun_spid_contc.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\physmod\powersys\powersys\sfun_spid_contc.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\physmod\powersys\powersys\sfun_spid_contc.c
